package com.estertz.minhasfinancas.api.resource;
...
import com.estertz.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.estertz.minhasfinancas.api.dto.LancamentoDTO;
...
import com.estertz.minhasfinancas.model.enums.StatusLancamento;
import com.estertz.minhasfinancas.model.enums.TipoLancamento;
import com.estertz.minhasfinancas.service.LancamentoService;
...
public class LancamentoResource {
	...
	public ResponseEntity atualizar( @PathVariable("id") Long id, @RequestBody LancamentoDTO dto ) {
		return service.obterPorId(id).map( entitiy -> {
			try {
